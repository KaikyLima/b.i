...
-- Schema world_x
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `dw` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
-- -----------------------------------------------------
-- Schema world
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `world_x`.`country`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `world_x`.`country` (
...
-- -----------------------------------------------------
-- Table `world_x`.`countrylanguage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `world_x`.`countrylanguage` (
  ...
  CONSTRAINT `countrylanguage_ibfk_1`
    ...
    REFERENCES `world_x`.`country` (`Code`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
